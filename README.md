...
**chaos theory** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
Chaos theory simulations — Lorenz, logistic map, strange attractors
